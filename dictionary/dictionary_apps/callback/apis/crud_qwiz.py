...
from dictionary.dictionary_apps.callback.models import Qwiz

from dictionary.dictionary_apps.callback.selectors import qwiz_get, qwiz_list
from dictionary.dictionary_apps.users.selectors import user_get

from dictionary.dictionary_apps.dtos.callback.response_dto import QwizDTO
from dictionary.dictionary_apps.dtos.callback.request_dto import CreateQwizDTO

from dictionary.dictionary_apps.callback.services import QwizService
from dictionary.dictionary_apps.callback.repository import QwizRepository

from dictionary.dictionary_apps.users.models import BaseUser

class QwizCreateApi(LoginRequiredMixin, LimitOffsetPagination, APIView):
