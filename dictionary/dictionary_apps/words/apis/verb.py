...
class VerbCreateApi(LoginRequiredMixin, LimitOffsetPagination, APIView):
    class InputSerializer(serializers.Serializer):
        ...
        past_prateritum_ich_form = serializers.CharField(required=False, allow_blank=True)
        past_prateritum_du_form = serializers.CharField(required=False, allow_blank=True)
        past_prateritum_er_sie_es_form = serializers.CharField(required=False, allow_blank=True)
        past_prateritum_wir_form = serializers.CharField(required=False, allow_blank=True)
        past_prateritum_ihr_form = serializers.CharField(required=False, allow_blank=True)
        past_prateritum_Sie_sie_form = serializers.CharField(required=False, allow_blank=True)
